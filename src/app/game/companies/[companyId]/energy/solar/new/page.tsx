// src/app/game/companies/[companyId]/energy/solar/new/page.tsx
// Created: 2025-12-06
// OVERVIEW: Page for creating a new Solar Energy Asset (AAA dashboard pattern)

import React from "react";
import { Card, CardHeader, CardBody, Button } from "@heroui/react";
import { useRouter } from "next/navigation";

export default function NewSolarAssetPage() {
  ...
  return (
    <div className="min-h-screen bg-dark-950 flex items-center justify-center">
      <Card className="w-full max-w-xl bg-dark-900 shadow-lg">
        <CardHeader>
          <h2 className="text-2xl font-bold text-white">Create New Solar Asset</h2>
        </CardHeader>
        <CardBody>
