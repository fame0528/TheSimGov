...
import type {
  MonetizationConfig as MonetizationDomain,
  MonetizationStrategy,
  SubscriptionTier
} from '../../../types/media';

// Extract domain shape excluding Mongoose-specific fields
type MonetizationBase = Omit<MonetizationDomain, '_id' | 'company' | 'targetDemographics' | 'excludedAdvertisers' | 'preferredAdvertisers' | 'createdAt' | 'updatedAt'>;

// Compose Mongoose document with domain base + ObjectId overrides
interface MonetizationDocument extends Document, MonetizationBase {
  _id: mongoose.Types.ObjectId;
  company: mongoose.Types.ObjectId;
  targetDemographics: mongoose.Types.ObjectId[];
  excludedAdvertisers: mongoose.Types.ObjectId[];
  preferredAdvertisers: mongoose.Types.ObjectId[];
  createdAt: Date;
  updatedAt: Date;
}

// Backward-compatible export alias
export type IMonetizationSettings = MonetizationDocument;

/**
 * CPM rate multiplier interface (local extension)
 */
...
/**
 * Affiliate category commission interface (local extension)
 */
...
/**
 * Platform revenue share interface (local extension)
 */
...
/**
 * MonetizationSettings schema interface (extends centralized + adds Mongoose fields)
 */
interface IMonetizationSettingsSchema extends Document {
  // Core
