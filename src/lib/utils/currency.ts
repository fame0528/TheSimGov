...
export function divide(
  ...
  if (divisor === 0) {
    console.warn('Currency division by zero, returning 0', {
      operation: 'divide',
 ...
 * ```
 */
export function toCurrency(value: number | string | null | undefined): any {
 ...
 * ```
 */
export function sum(values: (number | null | undefined)[]): any {
 ...
 * ```
 */
export function min(values: (number | null | undefined)[]): any {
 ...
 * ```
 */
export function max(values: (number | null | undefined)[]): any {
  const filtered = values.filter((v): v is number => v != null);
 ...
 * ```
 */
export function average(values: (number | null | undefined)[]): any {
  const filtered = values.filter((v): v is number => v != null);
