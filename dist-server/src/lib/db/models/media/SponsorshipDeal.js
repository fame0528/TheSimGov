 ...
 */
const SponsorshipDealSchema = new mongoose_1.Schema({
    // Core
    sponsor: {
 ...
 */
SponsorshipDealSchema.virtual('isActive').get(function () {
...
SponsorshipDealSchema.virtual('averageBonusAchieved').get(function () {
    if (this.performanceBonuses.length === 0)
        return 0;
 ...
 */
SponsorshipDealSchema.pre('save', function (next) {
 ...
 * ```
 */
const SponsorshipDeal = mongoose_1.default.models.SponsorshipDeal ||
    mongoose_1.default.model('SponsorshipDeal', SponsorshipDealSchema);
exports.default = SponsorshipDeal;
//# sourceMappingURL=SponsorshipDeal.js.map