 ...
 */
const MediaAdCampaignSchema = new mongoose_1.Schema({
    // Core
    platform: {
 ...
 */
MediaAdCampaignSchema.virtual('adRank').get(function () {
 ...
 */
MediaAdCampaignSchema.virtual('effectiveCPC').get(function () {
 ...
 */
MediaAdCampaignSchema.virtual('profitability').get(function () {
    if (this.acos < 15)
        return 'Excellent'; // < 15% ACOS
    if (this.acos < 25)
        return 'Good'; // 15-25% ACOS
    if (this.acos < 35)
        return 'Fair'; // 25-35% ACOS
    if (this.acos < 50)
        return 'Poor'; // 35-50% ACOS
 ...
 */
MediaAdCampaignSchema.virtual('budgetRemaining').get(function () {
    if (this.totalBudget === 0)
        return Infinity; // No budget cap
 ...
 */
MediaAdCampaignSchema.virtual('avgCostPerConversion').get(function () {
 ...
 */
MediaAdCampaignSchema.virtual('engagementEfficiency').get(function () {
 ...
 */
MediaAdCampaignSchema.pre('save', function (next) {
    ...
    const compositeScore = this.relevanceScore * relevanceWeight +
 ...
 * ```
 */
const AdCampaign = mongoose_1.default.models.AdCampaign || mongoose_1.default.model('AdCampaign', MediaAdCampaignSchema);
