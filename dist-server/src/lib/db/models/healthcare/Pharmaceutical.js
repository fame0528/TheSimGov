 ...
 */
const PharmaceuticalSchema = new mongoose_1.Schema({
    company: {
 ...
 * Indexes
 */
PharmaceuticalSchema.methods.calculatePipelineValue = function () {
    return this.pipeline.reduce((total, drug) => {
        return total + (drug.potentialRevenue * drug.successProbability / 100);
    }, 0);
};
PharmaceuticalSchema.methods.getActiveDrugs = function () {
    return this.pipeline.filter((drug) => drug.stage === 'Launched');
};
PharmaceuticalSchema.methods.assessRegulatoryRisk = function () {
 ...
 * Static Methods
 */
PharmaceuticalSchema.statics.findByCompany = function (companyId) {
    return this.find({ company: companyId });
};
PharmaceuticalSchema.statics.findByFocusArea = function (focusArea) {
 ...
 */
const Pharmaceutical = mongoose_1.default.models.Pharmaceutical || mongoose_1.default.model('Pharmaceutical', PharmaceuticalSchema);
exports.default = Pharmaceutical;
//# sourceMappingURL=Pharmaceutical.js.map