...
exports.BankPersonality = void 0;
const mongoose_1 = __importStar(require("mongoose"));
/**
 * Bank personality types
 */
var BankPersonality;
(function (BankPersonality) {
    BankPersonality["CONSERVATIVE"] = "CONSERVATIVE";
    BankPersonality["GROWTH"] = "GROWTH";
    BankPersonality["RISK_TAKING"] = "RISK_TAKING";
    BankPersonality["COMMUNITY"] = "COMMUNITY";
    BankPersonality["TECH_FOCUSED"] = "TECH_FOCUSED";
})(BankPersonality || (exports.BankPersonality = BankPersonality = {}));
/**
 * Bank schema
 */
 ...
 */
BankSchema.statics.getEligibleBanks = function (creditScore, loanAmount) {
    return this.find({
        isActive: true,
 ...
 */
BankSchema.statics.getBanksByPersonality = function (personality) {
    return this.find({
        personality,
        isActive: true,
    });
 ...
 */
BankSchema.methods.canApproveLoan = function (creditScore, loanAmount, companyIndustry) {
 ...
 */
BankSchema.methods.calculateInterestRate = function (baseRate, creditScore, loanAmount) {
    let adjustment = 0;
    // Credit score adjustment
    if (creditScore >= 800)
        adjustment -= 0.02; // 2% discount
    else if (creditScore >= 740)
        adjustment -= 0.01; // 1% discount
    else if (creditScore >= 670)
        adjustment += 0.01; // 1% premium
    else if (creditScore >= 580)
        adjustment += 0.02; // 2% premium
    else
        adjustment += 0.03; // 3% premium for poor credit
...
const Bank = mongoose_1.default.models.Bank || mongoose_1.default.model('Bank', BankSchema);
