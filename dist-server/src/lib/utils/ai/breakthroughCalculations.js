...
exports.calculateBreakthroughProbability = calculateBreakthroughProbability;
exports.calculateNoveltyScore = calculateNoveltyScore;
exports.isPatentable = isPatentable;
exports.generateBreakthroughDetails = generateBreakthroughDetails;
/**
 ...
 */
function calculateBreakthroughProbability(area, computeBudgetUSD, avgResearcherSkill) {
    ...
    const combinedProbability = Math.min(0.95, baseProbability * budgetMultiplier * skillMultiplier);
    return {
 ...
 */
function calculateNoveltyScore(area, performanceGainPercent, efficiencyGainPercent) {
 ...
 */
function isPatentable(area, noveltyScore, performanceGainPercent, efficiencyGainPercent) {
    ...
    const estimatedValue = Math.round(baseValue * noveltyMultiplier * gainMultiplier * areaMultipliers[area]);
    // Cap at $50M
 ...
 */
function generateBreakthroughDetails(name, area, performanceGainPercent, efficiencyGainPercent) {
    const noveltyScore = calculateNoveltyScore(area, performanceGainPercent, efficiencyGainPercent);
    const patentability = isPatentable(area, noveltyScore, performanceGainPercent, efficiencyGainPercent);
    return {
        name,
        area,
 ...
 */
//# sourceMappingURL=breakthroughCalculations.js.map