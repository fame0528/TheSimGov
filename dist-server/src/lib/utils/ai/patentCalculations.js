...
exports.calculatePatentFilingCost = calculatePatentFilingCost;
exports.calculateLicensingRevenue = calculateLicensingRevenue;
exports.calculatePatentValueFromCitations = calculatePatentValueFromCitations;
exports.estimatePatentGrantProbability = estimatePatentGrantProbability;
 ...
 */
function calculatePatentFilingCost(area, international = false, jurisdictions = []) {
    // Base filing fees by area (technical complexity)
    const baseFilingFees = {
        Performance: 5000,
        Efficiency: 6000,
    ...
    const jurisdictionFees = jurisdictions.reduce((sum, jurisdiction) => sum + (jurisdictionFeesMap[jurisdiction] || 0), 0);
 ...
 */
function calculateLicensingRevenue(patentValue, citations, yearsSinceGrant) {
 ...
 */
function calculatePatentValueFromCitations(initialValue, citations) {
 ...
 */
function estimatePatentGrantProbability(noveltyScore, area) {
    // Base approval rates by area (USPTO historical data for AI patents)
    const baseApprovalRates = {
        Performance: 0.55,
        Efficiency: 0.58,
 ...
 */
function calculatePortfolioValue(patents) {
    if (patents.length === 0) {
 ...
 */
//# sourceMappingURL=patentCalculations.js.map