...
exports.getParameterRangeForSize = getParameterRangeForSize;
exports.validateProgressIncrement = validateProgressIncrement;
exports.validateResearchBudget = validateResearchBudget;
exports.validateBudgetOverage = validateBudgetOverage;
exports.getComplexityMultiplier = getComplexityMultiplier;
 ...
 */
function getParameterRangeForSize(size) {
    const ranges = {
        Small: '0-10B',
        Medium: '10B-80B',
        Large: '>80B',
 ...
 */
function validateProgressIncrement(increment, currentProgress) {
 ...
 */
function validateResearchBudget(budget) {
