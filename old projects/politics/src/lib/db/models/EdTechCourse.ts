/**
 * @file src/lib/db/models/EdTechCourse.ts
 ...
 * - category: Subject area (Programming, Business, Design, Marketing, Data Science)
 ...
 * - Categories: Programming (web, mobile, systems), Business (MBA, marketing, finance), Design (UI/UX, graphic), Marketing (digital, SEO, content), Data Science (ML, analytics, AI)
 ...
 */
export type CourseCategory = 'Programming' | 'Business' | 'Design' | 'Marketing' | 'Data Science';
...
const EdTechCourseSchema = new Schema<IEdTechCourse>(
  {
    ...
    category: {
      ...
      required: true,
      enum: {
        values: ['Programming', 'Business', 'Design', 'Marketing', 'Data Science'],
 ...
 *   duration: 120,
 *   lessons: 50,
 *   curriculum: ["HTML/CSS Fundamentals", "JavaScript ES6+", "React", "Node.js", "MongoDB", "Deployment"],
 *   videoHours: 80,
 *   exerciseCount: 100,
 *   projectCount: 5,
 *   instructors: ["Jane Doe", "John Smith"],
 *   prerequisites: ["Basic programming knowledge"],
 *   requiredTools: ["VS Code", "Git", "Node.js"],
 *   skillTags: ["React", "Node.js", "MongoDB", "Full-Stack"],
 ...
 * 
 * // Check course health
 * console.log(course.completionRate); // e.g., 65% completion
 * console.log(course.rating); // e.g., 92% student rating
 * console.log(course.revenuePerStudent); // e.g., $499 ARPU
 * console.log(course.profitMargin); // e.g., 88% margin
 * ```
 */
