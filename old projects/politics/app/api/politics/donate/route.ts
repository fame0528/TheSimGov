/**
 * @file app/api/politics/donate/route.ts
...
export async function POST(request: Request) {
  try {
    ...
    // Check donation cap
    const maxDonation = getMaxDonation(company.level);
    ...
    const influenceGained = calculateInfluencePoints(amount, company.level);
